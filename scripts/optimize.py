...
def run_optimization(task_name, model_name, x_data, y_data, weight_data, cv, n_trials_long, n_trials_short, patience, scoring, calibration, n_jobs, drop_rate=0.50, min_columns_to_keep=8, test=False):
	"""
	...
	best_hyperparameters_dictionary, weight_adjustment = optimize_hyperparameters(x_data, y_data, weight_data, cv, {}, n_jobs, n_trials_long, patience, scoring, 'long', task_name, model_name, metric_dictionary, test)
	...
	best_hyperparameters_dictionary, _ = optimize_hyperparameters(x_data[important_features_list], y_data, weight_data, cv, best_hyperparameters_dictionary, n_jobs, n_trials_short, patience, scoring, 'short', task_name, model_name, metric_dictionary, test)
